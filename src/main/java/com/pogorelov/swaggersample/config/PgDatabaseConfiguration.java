...
@EnableJpaRepositories(basePackages = "com.pogorelov.swaggersample.repository.pg",
        entityManagerFactoryRef = "pgEntityManagerFactory",
        transactionManagerRef = "pgTransactionManager")
public class PgDatabaseConfiguration {

    public static final String PG_TRANSACTION_MANAGER = "pgTransactionManager";
    public static final String MAIN_PERSISTENCE_UNIT = "pgPersistenceUnit";
    private static final String DOMAIN_PACKAGE = "com.pogorelov.swaggersample.domain.pg";
    ...
    @Bean("pgDataSource")
    @ConfigurationProperties(prefix = "pg.datasource.hikari")
    public HikariDataSource pgDataSource(@Qualifier("pgDataSourceProperties") DataSourceProperties properties) {
    ...
    @Bean("pgJpaVendorAdapter")
    public JpaVendorAdapter pgJpaVendorAdapter(@Qualifier("pgJpaProperties") JpaProperties properties) {
    ...
    @Bean("pgEntityManagerFactoryBuilder")
    public EntityManagerFactoryBuilder pgEntityManagerFactoryBuilder(
            @Qualifier("pgJpaVendorAdapter") JpaVendorAdapter jpaVendorAdapter,
    ...
    public LocalContainerEntityManagerFactoryBean pgEntityManagerFactory(
            @Qualifier("pgEntityManagerFactoryBuilder") EntityManagerFactoryBuilder builder,
